...
{
  \begin{itemize}
    \item {\small Main developer of the Control Unit Software for the SAOCOM satellite (CONAE).}
  \end{itemize}
}
...
\subsection{\small Exacts, Physics and Natural Sciences School}\textit{\small IT support \& Sysadmin}{\textcolor{subsectioncolor}{\textbf{\hfill \small Sep 2007 - Aug 2011}}
